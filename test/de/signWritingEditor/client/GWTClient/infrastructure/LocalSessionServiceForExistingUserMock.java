...
public class LocalSessionServiceForExistingUserMock implements LocalSessionService {

	private User user;

	public LocalSessionServiceForExistingUserMock() {
		user = new User("test", "testi", "testmann", new EmailAddress("testi.testmann@yahoo.com"),
