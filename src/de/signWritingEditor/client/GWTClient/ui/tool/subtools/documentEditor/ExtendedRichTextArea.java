...
public class ExtendedRichTextArea extends TextArea {
	...
	public ExtendedRichTextArea(EventTranslatorStandardImpl eventTranslator, FontSizeService fontSizeService) {
